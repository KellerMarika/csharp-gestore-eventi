...
namespace GestoreEventi
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Conferenza co1 =new Conferenza("t1",new DateTime(2024,02,20),10,"Pinco Pallo", 22);
            userEventProgram.AddEvent(co1);

            Console.WriteLine($"ELENCO PROGRAMMA {userEventProgram.Titolo.ToUpper()} EVENTI & CONFERENZE");
            foreach (var item in userEventProgram.Eventi)
            {
